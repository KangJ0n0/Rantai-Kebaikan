    ...
    <div class="relative flex items-center justify-between">
      <a href="/" aria-label="Company" title="Company" class="inline-flex items-center">
        ...
        <ul class="flex items-center hidden space-x-8 lg:flex">
          <li><a href="{{ url('/') }}" aria-label="Our product" title="Our product" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Home</a></li>
          <li><a href="{{ url('/galangdana') }}" aria-label="Our product" title="Our product" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Galang Dana</a></li>
          <li><a href="{{ url('/request') }}" aria-label="Product pricing" title="Product pricing" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Request</a></li>
          <li><a href="{{ url('/informasi') }}" aria-label="About us" title="Informasi" class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-teal-accent-400">Informasi</a></li>
        </ul>
      <ul class="flex items-center hidden space-x-8 lg:flex">
        <li>
